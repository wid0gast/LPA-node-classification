...
def load_corpus(dataset_str):
    ...
    adj_n = adj + adj.T.multiply(adj.T > adj) - adj.multiply(adj.T > adj)

    return adj, adj_n, features, y_train, y_val, y_test, train_mask, val_mask, test_mask, train_size, test_size
